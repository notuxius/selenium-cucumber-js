module.exports = {
  ...
  getElementsContainingText: function (cssSelector, textToMatch) {
    ...
    return driver.findElements(
      by.js(findElementsContainingText, cssSelector, textToMatch)
    );
  },
  ...
  clickHiddenElement: function (cssSelector, textToMatch) {
    ...
    // grab matching elements
    return driver.findElements(
      by.js(clickElementInDom, cssSelector, textToMatch)
    );
  },
   ...
   */
  waitUntilAttributeEquals: function (
    elementSelector,
    attributeName,
    attributeValue,
    waitInMilliseconds
    ...
    return driver.wait(
      function () {
        ...
        return helpers
          .getAttributeValue(elementSelector, attributeName)
          .then(function (value) {
            // inspect the value
   ...
   */
  waitUntilAttributeExists: function (
    elementSelector,
    attributeName,
    waitInMilliseconds
  ) {
   ...
   */
  waitUntilAttributeDoesNotExists: function (
    elementSelector,
    attributeName,
    waitInMilliseconds
  ) {
  ...
  waitForCssXpathElement: function (elementSelector, waitInMilliseconds) {
    ...
    return driver.wait(
      selenium.until.elementLocated({ [selector]: elementSelector }),
      timeout,
      timeoutMessage
    );
  },
   ...
   */
  selectDropdownValueByVisibleText: async function (
    elementSelector,
    optionName
  ) {
